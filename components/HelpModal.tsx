    ...
    <>
      ...
      <div className={styles.faqBlock}>
        ...
        <p>
          ...
          homage with our name. A &apos;Worldie&apos; is a term used
          to describe amazing or world-class goals, so the convoluted
          pun of Worldiesle was too good (/bad) to resist. Sorry.
        </p>
      </div>
      <div className={styles.faqBlock}>
        ...
        <p>
          ...
          World Cup and European Championship matches. There will be
          no goals chosen prior to 1990, due to the difficulty in
      ...
      <div className={styles.faqBlock}>
        ...
        <p>
          ...
          but any teams/players that appear in answers will be
          available to select.
        </p>
      </div>
      <div className={styles.faqBlock}>
        ...
        <p>
          Yes and no. In Premier League matches, you have to ensure
          the home team and away team are guessed correctly. We think
          there is some fun in identifying the stadium from the
          pictures as part of the game. However, given that some cup
          and most international games are played on neutral teritory,
          for those games the order you guess teams in does not
          matter.
        </p>
      </div>
      <div className={styles.faqBlock}>
        ...
        <p>
          ...
          meaningful clues for teams and players from previous
          guesses. We are working to improve this, but for now, it is
          mostly each new image that will have to guide you.
        </p>
      </div>
      <div className={styles.faqBlock}>
